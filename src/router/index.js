...
const router = new VueRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "admin",
      component: () =>
        import("../components/admin/components/SidebarNavbar.vue"),
      children: [
        {
          path: "/",
          name: "dashboard",
        ...
        },
        {
          ...
          name: "personal",
          component: () =>
            import("../components/admin/personal/TablePersonal.vue"),
        },
        {
          path: "/admin/banquetes",
          name: "banquetes",
          component: () =>
            import("../components/admin/banquetes/TableBanquetes.vue"),
        },
        {
        ...
        },
        {
          ...
          name: "eventos",
          component: () =>
            import("../components/admin/eventos/TableEventos.vue"),
        },
        {
          path: "/admin/roles",
          name: "roles",
        ...
        },
        {
          ...
          name: "servicios",
          component: () =>
            import("../components/admin/services/TableServices.vue"),
        },
        {
          path: "/admin/categorias",
          name: "categorias",
          component: () =>
            import("../components/admin/categories/TableCategories.vue"),
        },
        {
          path: "/admin/paquete",
          name: "package",
          component: () =>
            import("../components/admin/paquete/TablePackages.vue"),
        },
        {
      ...
      children: [
        {
          ...
          name: "paquetes",
          component: () =>
            import("../components/cliente/components/Inicio.vue"),
        },
        {
          path: "/home/servicios/",
          name: "serviciosCliente",
          component: () =>
            import("../components/cliente/components/Servicios.vue"),
        },
        {
          path: "/home/inicio/",
          name: "inicio",
          component: () =>
            import("../components/public/Landing-pages/LandingPage.vue"),
        },
        {
          path: "/home/perfil/",
          name: "perfil",
        ...
        },
        {
          ...
          name: "carrito",
          component: () =>
            import("../components/cliente/components/ShoppingCart.vue"),
        },
        {
          path: "/home/pedido",
          name: "pedido",
