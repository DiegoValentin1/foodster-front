    ...
    <div class="hidden w-27 bg-gray-900 overflow-y-auto md:block">
      <div class="w-full py-6 flex flex-col items-center">
        ...
        <div class="flex-1 mt-6 w-full px-2 space-y-1">
          <!-- Current: "bg-indigo-800 text-white", Default: "text-indigo-100 hover:bg-gray-800 hover:text-white" -->
          <a href="/admin"
          ...
          <a href="/admin/descuentos"
            ...
            <span class="mt-2">Descuentos</span>
          </a>
          ...
          <div class="mt-5 flex-1 h-0 px-2 overflow-y-auto">
            <nav class="h-full flex flex-col">
              <div class="space-y-1">
                <!-- Current: "bg-indigo-800 text-white", Default: "text-indigo-100 hover:bg-gray-800 hover:text-white" -->
                <a href="#"
                   class="text-indigo-100 hover:bg-gray-800 hover:text-white group py-2 px-3 rounded-md flex items-center text-sm font-medium">
                  <!--
                  Heroicon name: outline/home
...
<<<<<<< HEAD
                ...
                <div v-show="menuOpen"
                  ...
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                    id="user-menu-item-0" style="color: #03071E;">
                    <v-icon dark left aria-hidden="false" color="#03071E">
                      mdi-account
                    </v-icon>
                    Perfil</a>
                  <v-divider></v-divider>
                  <a href="/" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                    id="user-menu-item-1" style="color: #9D0208;">
                   
                    <v-icon dark left color="#9D0208">
                      mdi-arrow-left
                    </v-icon>
                    Cerrar Sesión
                  </a>
...
=======
              ...
              <button
                  type="button"
                  class="flex bg-gray-600 p-1 rounded-full items-center justify-center text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
